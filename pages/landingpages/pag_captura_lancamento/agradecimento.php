    ...
    <main>
        <div class="parte4">
            <div class="imagem_parte4">
                <img class="img_estrelas" src="img/alex_agradecimento.webp" alt="Alex 2" />
                <!-- <img class="img_estrelas_tela" src="img/evento1.webp" alt="Imagem de Estrelas" /> -->

            </div>
            <div class="textos">
               <h2>SUA INSCRIÇÃO ESTÁ QUASE CONFIRMADA!</h2>
                <!-- <h4>MARCATTI SEGURANÇA EM EVENTOS</h4> -->
                <p>
                Clique no botão abaixo para entrar no grupo silencioso do WhatsApp e receber o aviso quando a aula estiver começando!

                </p>
                <div class="col-12 m-0 p-0">
                    <br>
                    <p>
                        <a href="https://chat.whatsapp.com/IhC35XjsXtXJyDAs1iBYiP" class="btn btn-primary btn-lg btn-block botao" type="submit">Grupo Whatsapp</a>
